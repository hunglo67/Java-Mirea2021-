...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        SortingStudentsbyID.insertSortByIDNumber(students);
        System.out.print(students + "\n");
        System.out.println("--------------------------------------------------------");

        System.out.println("Быстрая сортировка по GPA:");
        Comparator<Student> compareByGPA = new SortingStudentsbyGPA();
        System.out.println("Без компаратора");
        SortingStudentsbyGPA.quickSortByGPA(students, 0, students.size()-1);
